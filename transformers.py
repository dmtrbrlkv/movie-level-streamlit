...
class WordsLevel(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, vocabulary_path='../data/vocabulary/american/full.txt'):
    ...
    def transform(self, X, y=None):
        ...
        stats = stats.apply(self._expand_array)
...
class Vectorizer(BaseEstimator, TransformerMixin):
    def __init__(self, max_features=1500, min_df=5, max_df=0.7):
